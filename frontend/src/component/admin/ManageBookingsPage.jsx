...
const ManageBookingsPage = () => {
    ...
    // 2. WRAP filterBookings in useCallback
    // This tells React to only re-create this function if the `bookings` state changes.
    const filterBookings = useCallback((term) => {
        ...
        setCurrentPage(1);
    }, [bookings]); // The dependency for useCallback is `bookings`

    useEffect(() => {
        filterBookings(searchTerm);
    }, [searchTerm, filterBookings]); // 3. UPDATE the dependency array. The warning is now gone.
