...
public class Utils {
    ...
    // THIS IS THE METHOD WE ARE DEBUGGING
    public static RoomDTO mapRoomEntityToRoomDTO(Room room) {
        ...
        if (room.getRoomPhotoUrl() != null && !room.getRoomPhotoUrl().isBlank()) {
            roomDTO.setRoomPhotoUrl(BASE_FILE_URL + room.getRoomPhotoUrl());
        }
        return roomDTO;
    }

    // ... (all other mapping methods remain the same) ...
